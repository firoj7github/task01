<template>
        <div
        class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-gray-500"
    >
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm bg-white p-10 rounded">
